...
@section('content')
    ...
    <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
        ...
        {{-- Demo disclaimer — remove once real content is in place. --}}
        <p class="mt-10 rounded-lg border border-dashed border-rule bg-paper-soft px-5 py-4 text-sm text-ink/55">
            ...
            Every article, company, product and byline on this site is fictional placeholder content
            generated by the database seeder.
        </p>
    </div>
@endsection
