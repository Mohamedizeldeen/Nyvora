...
@php
    ...
    $nav = [
        ...
        ['route' => 'admin.account.edit', 'label' => 'Your account', 'match' => 'admin.account.*', 'icon' => 'M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z'],
    ];
@endphp
<!DOCTYPE html>
...
<div class="flex min-h-screen flex-col lg:flex-row">
    ...
    <div class="bg-ink text-white lg:flex lg:w-64 lg:shrink-0 lg:flex-col">
        ...
        <div class="mt-auto hidden border-t border-ink-line p-4 lg:block">
            <a href="{{ route('admin.account.edit') }}" class="group block">
                <p class="truncate text-sm font-bold group-hover:text-brand-light">{{ auth()->user()->name }}</p>
